...
const router = useRouter();
  ...
  const metrics = [
    { title: "Agility and Mobility", icon: "run-fast" },
    { title: "Benchmarking", icon: "chart-line" },
    { title: "Body Composition", icon: "human-male-height" },
    { title: "Improvement Rate", icon: "trending-up" },
    { title: "Jump Tests", icon: "arrow-up-bold" },
    { title: "Reaction Time", icon: "timer-sand" },
    { title: "Strength Metrics", icon: "weight-lifter" },
  ];
  ...
  return (
    <View style={[styles.container, { backgroundColor: "#1A394B" }]}>
      ...
      <Text style={[styles.subHeader, { color: colors.muted }]}>
        Check the team’s average based on their training performance.
      </Text>
