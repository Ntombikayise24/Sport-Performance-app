    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.menuAndCoachContainer}>
          ...
          <TouchableOpacity style={styles.coachImageContainer} onPress={pickImage}>
            <Image
      ...
      <TouchableOpacity style={styles.teamOverviewButton} onPress={() => router.push('/team-overview')}>
        <Ionicons name="people-outline" size={24} color="#1A394B" />
        <Text style={styles.teamOverviewText}>Team Overview</Text>
      </TouchableOpacity>

      {/* Notifications Section */}
      <TouchableOpacity style={styles.notificationsContainer} onPress={() => router.push('/notifications')}>
        <Text style={styles.notificationsTitle}>Notifications</Text>
        <View style={styles.notificationItem}>
          <Ionicons name="alert-circle-outline" size={20} color="#FF0000" />
          <Text style={styles.notificationText}>Naledi Motaung is on red alert.</Text>
        </View>
        <View style={styles.notificationItem}>
          <Ionicons name="alert-circle-outline" size={20} color="#FF0000" />
          <Text style={styles.notificationText}>Ayanda Dlamini is on red alert.</Text>
        </View>
        <View style={styles.notificationItem}>
          <Ionicons name="alert-circle-outline" size={20} color="#FFA500" />
          <Text style={styles.notificationText}>Sarah van de Merwe is on amber alert.</Text>
        </View>
      </TouchableOpacity>

      {/* Training Plans Button */}
      <TouchableOpacity style={styles.trainingPlansButton} onPress={() => router.push('/training-plans')}>
