...
export default function Vikings() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Buttons */}
      <TouchableOpacity style={styles.button} onPress={() => router.push('/athletes')}>
        <Text style={styles.buttonText}>List of athletes</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.button} onPress={() => router.push('/overall-team-form')}>
        <Text style={styles.buttonText}>Overall team form</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.button} onPress={() => router.push('/check-injuries')}>
