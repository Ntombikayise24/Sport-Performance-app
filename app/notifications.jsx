  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.push('/coachview')} activeOpacity={0.7}>
      ...
      <View style={styles.sortContainer}>
        <TouchableOpacity style={styles.sortButton} onPress={sortNotifications}>
          <Text style={styles.sortButtonText}>Sort {sortOrder === 'asc' ? '▲' : '▼'}</Text>
        </TouchableOpacity>
      </View>
            ...
            {notifications.map((notification) => (
              <View key={notification.id} style={styles.notificationItem}>
                ...
                <View style={styles.notificationTextContainer}>
                  ...
                  <Text style={[styles.alertText, { color: alertColors[notification.alert] }]}>
